...
async def create_session(
    redis: Redis, user_id: str, settings: Settings
) -> Tuple[str, str]:
...
async def get_session(
    redis: Redis, session_id: str, settings: Settings
) -> Optional[Dict]:
...
async def rotate_session_id(
    redis: Redis, old_session_id: str, settings: Settings
) -> Tuple[str, str]:
...
async def check_rate_limit(
    redis: Redis, key: str, max_attempts: int, window_seconds: int
) -> bool:
